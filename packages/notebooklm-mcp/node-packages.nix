...
let
  sources = {
    ...
    "patchright-1.57.0" = {
      ...
      version = "1.57.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/patchright/-/patchright-1.57.0.tgz";
        sha512 = "pxbI/D65QiFuCY3qUXKQONRhplR3rkYFhry5ieimEbzLNxu/xfOYizQRyuMgc6F5ZoZ37QNIwZz9PWEfn6aC1Q==";
      };
    };
    "patchright-core-1.57.0" = {
      name = "patchright-core";
      packageName = "patchright-core";
      version = "1.57.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/patchright-core/-/patchright-core-1.57.0.tgz";
        sha512 = "um/9Wue7IFAa9UDLacjNgDn62ub5GJe1b1qouvYpELIF9rsFVMNhRo/rRXYajupLwp5xKJ0sSjOV6sw8/HarBQ==";
      };
    };
    "path-key-3.1.1" = {
      name = "path-key";
...
in
{
  notebooklm-mcp = nodeEnv.buildNodePackage {
    name = "notebooklm-mcp";
    packageName = "notebooklm-mcp";
    version = "1.2.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/notebooklm-mcp/-/notebooklm-mcp-1.2.1.tgz";
      sha512 = "7xq+sBO8m15Bki+37KpQ8BdlXk0k8R3T3RcBvdqnrk5x2U8fYSZCsk31dCkgSBArjldUT40uqxwY+0ZLzPpPCQ==";
    };
    dependencies = [
      ...
      sources."patchright-1.57.0"
      sources."patchright-core-1.57.0"
