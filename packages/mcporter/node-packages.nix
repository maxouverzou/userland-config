  ...
  sources = {
    ...
    "@oxc-project/types-0.103.0" = {
      ...
      src = fetchurl {
        ...
        sha512 = "bkiYX5kaXWwUessFRSoXFkGIQTmc6dLGdxuRTrC+h8PSnIdZyuXHHlLAeTmOue5Br/a0/a7dHH0Gca6eXn9MKg==";
      };
    };
    "@rolldown/pluginutils-1.0.0-beta.57" = {
      ...
      src = fetchurl {
        ...
        sha512 = "aQNelgx14tGA+n2tNSa9x6/jeoCL9fkDeCei7nOKnHx0fEFRRMu5ReiITo+zZD5TzWDGGRjbSYCs93IfRIyTuQ==";
      };
    };
    "accepts-2.0.0" = {
      name = "accepts";
    ...
    "ora-9.1.0" = {
      ...
      version = "9.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/ora/-/ora-9.1.0.tgz";
        sha512 = "53uuLsXHOAJl5zLrUrzY9/kE+uIFEx7iaH4g2BIJQK4LZjY4LpCCYZVKDWIkL+F01wAaCg93duQ1whnK/AmY1A==";
      };
    };
    "parseurl-1.3.3" = {
      name = "parseurl";
    ...
    "rolldown-1.0.0-beta.57" = {
      ...
      src = fetchurl {
        ...
        sha512 = "lMMxcNN71GMsSko8RyeTaFoATHkCh4IWU7pYF73ziMYjhHZWfVesC6GQ+iaJCvZmVjvgSks9Ks1aaqEkBd8udg==";
      };
    };
    "router-2.2.0" = {
      name = "router";
...
in
{
  mcporter = nodeEnv.buildNodePackage {
    name = "mcporter";
    packageName = "mcporter";
    version = "0.7.3";
    src = fetchurl {
      url = "https://registry.npmjs.org/mcporter/-/mcporter-0.7.3.tgz";
    ...
    dependencies = [
      ...
      sources."@oxc-project/types-0.103.0"
      sources."@rolldown/pluginutils-1.0.0-beta.57"
      ...
      sources."rolldown-1.0.0-beta.57"
    ...
    meta = {
      ...
      homepage = "https://github.com/steipete/mcporter#readme";
      license = "MIT";
    };
    production = true;
    bypassCache = true;
